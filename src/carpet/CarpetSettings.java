...
public class CarpetSettings
{
    ...
    public static boolean commandRepopulate = true;

    // ===== HackerRouter'S ADDITIONAL FUNCTIONS ===== //
    /*
     * START from here.
     */
    @Rule(desc = "Fixed the path find and the dragon breath. The server won't crash anymore and you can freeze the dragon if you enable this!", category = FIX)
    @BugFixDefault
    public static boolean dragonCrashingFix = false;
    @Rule(desc = "Enable this to prevent the dragon fight NBT tags from being saved.", category = FEATURE)
    public static boolean doDragonFightNBTTagSave = true;

    @Rule(desc = "Disable this to make the game check the dragon fight status more than once. You need to restart the server to make it work.", category = FEATURE, extra = {"WARNING! the debug logs might spam massivly into your console!"})
    public static boolean autoDisableLegacyDragonFightScan = true;
